...
.splide__track{
    overflow:hidden;position:relative;z-index:0}@keyframes splide-loading{0%{transform:rotate(0)}to{transform:rotate(1turn)}
}
...
.splide__arrow{
    -ms-flex-align:center;align-items:center;background: transparent;border:0;border-radius:50%;cursor:pointer;display:-ms-flexbox;display:flex;height:8em;-ms-flex-pack:center;justify-content:center;opacity:.7;padding:0;position:absolute;top:43%;transform:translateY(-50%);width:8em;z-index:1
}

.splide__arrow svg{fill:#ffffff;height:5.2em;width:5.2em
}
...
.splide__pagination__page{
    background:#ccc;border:0;border-radius:10%;display:inline-block;height:3px;margin:7px;opacity:.7;padding:0;position:relative;transition:transform .2s linear;width:24px
}
